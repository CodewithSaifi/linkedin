...
const LandingPageNavbar = () => {
  return (
    <>
      <nav className="flex justify-between items-center max-w-[1128px] mx-auto pt-[12px] pb-[16px]">
        {/* Logo */}
        ...
        <div className="flex justify-center items-center">
          <NavBtn
            ...
            svg={
              <svg
                className="w-[24px] h-[24px] text-[#666666] transition duration-200 group-hover:text-[#303030]"
          ...
          />
          <NavBtn className={'border-r-[0.1px] border-l-[0.1px] border-[#ebebeb] px-[8px] mx-[8px] w-[96px]'}
            text="Get the app"
            svg={
              <svg
                className="w-[24px] h-[24px] text-[#666666] transition duration-200 group-hover:text-[#303030]"
          ...
          <BtnMd
            text="Join now"
            className="border-0 hover:bg-[#f3f2f0] mr-[10px]"
          />
          <BtnMd
            text="Sign in"
